package codes.ifelse.vfarm.repository;

import codes.ifelse.vfarm.CodeForFutureApp;

import codes.ifelse.vfarm.config.Constants;
import codes.ifelse.vfarm.config.audit.AuditEventConverter;
import codes.ifelse.vfarm.domain.PersistentAuditEvent;
...
import static codes.ifelse.vfarm.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
